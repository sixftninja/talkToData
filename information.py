...
gpt_example_qa_1 = [["When did the machine go offline?", "At 8 p.m."], ["What was the machine's output at 7 a.m.?", ".60"], ["What was the Machine's status at 5:30 p.m.?", "Online-Warning"]]

st_example_qa_1 = "Q: When did the machine go offline?\nA: At 8 p.m.\nQ:What was the machine's output at 7 a.m.?\n.60\nQ: What was the Machine's status at 5:30 p.m.?\nA: Online-Warning"
...
gpt_example_qa_2 = [["When did the machine go offline?", "At 4 p.m."], ["What was the machine's output at 7 a.m.?", ".583"], ["What was the Machine's status at 3:30 p.m.?", "Online-Critical"]]
st_example_qa_2  = "Q: When did the machine go offline?\nA: At 4 p.m.\nQ:What was the machine's output at 7 a.m.?\nA: .583\nQ: What was the Machine's status at 3:30 p.m.?\nA: Online-Critical"
